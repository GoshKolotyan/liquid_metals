...
from train import ChemicalTransformerLightning  # Import the Lightning module
...
def load_lightning_model(checkpoint_path, config=None):
    ...
    if checkpoint_path.endswith('.ckpt'):
        ...
        try:
            model = ChemicalTransformerLightning.load_from_checkpoint(checkpoint_path, weights_only=False)
            ...
            model = ChemicalTransformerLightning.load_from_checkpoint(checkpoint_path)
    else:
        ...
        print(f"Creating model with config: hidden_dim={config['hidden_dim']}, " 
